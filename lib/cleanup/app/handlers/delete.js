...
async function deleteDBRecords(customerUUID) {
  ...
  prepareDeleteCustomerRequests(customerRecords, customerUUID, deleteCustomerRequests);
...
function prepareDeleteCustomerRequests(customerRecords, customerUUID, deleteCustomerRequests) {
