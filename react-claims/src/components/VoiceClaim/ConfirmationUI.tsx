...
/**
 * Props for ConfirmationUI component
 */
interface ConfirmationUIProps {
  /** Complete claim data to display for confirmation */
  claimData: ClaimData;
  
  /** Callback when user confirms and wants to submit */
  onConfirm: () => void;
  
  /** Callback when user wants to edit/change information */
  onEdit: () => void;
}
 ...
 */
export const ConfirmationUI: React.FC<ConfirmationUIProps> = ({
  claimData,
  onConfirm,
  onEdit
}) => {
