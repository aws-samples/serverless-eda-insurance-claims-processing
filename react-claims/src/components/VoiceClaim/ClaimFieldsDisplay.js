 ...
 * @param {Object} props.claimData - Partial claim data with fields that have been extracted
 */
export const ClaimFieldsDisplay = ({ claimData }) => {
   ...
   * @param {string|number|boolean|undefined|null} value - Field value
   ...
   * @returns {string|undefined} Formatted location string
   */
   ...
   * @returns {string|undefined} Formatted other party information
   */
